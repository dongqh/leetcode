 ...
 *     running at most n times each time (where n is the size of the string
 *array). Space complexity: O(m) The space required to store the result string.
 *
 **/
